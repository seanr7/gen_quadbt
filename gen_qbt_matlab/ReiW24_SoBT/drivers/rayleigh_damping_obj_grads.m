function [objFunc, grads] = rayleigh_damping_obj_grads(params, nodes, tfEvals, ...
                                                       Kr,     Br,    Cpr, ...
                                                       Cvr)
%RAYLEIGH_DAMPING_OBJ_GRADS Function to output minimization objective and
%   corresponding gradients for the minimization problem (5.3) when the
%   reduced-order matrices are given. 
%
% SYNTAX:
%   [objFunc, grads] = rayleigh_damping_obj_grads(params, nodes, tfEvals, ...
%                                                 Kr,     Br,    Cpr, ... 
%                                                 Cvr)
%   objFunc          = rayleigh_damping_obj_grads(params, nodes, tfEvals, ...
%                                                 Kr,     Br,    Cpr, ... 
%                                                 Cvr)
%
%
...
%   companion paper when the reduced-order model matrices are given.
%   To be used in a post-processing step following soQuadpvBT.
%
% INPUTS:
...
%   grads   - gradients of the objective function of Theorem 5.1 in the 
%             companion paper, evaluated at params
% 
