...
nodes_200 = 1i*logspace(-4, 2, N/2)'; % Halve since we will add complex conjugates
...
nodes_400 = 1i*logspace(-4, 2, N/2)'; % Halve since we will add complex conjugates
% Interweave left/right points
...
nodes_800 = 1i*logspace(-4, 2, N/2)'; % Halve since we will add complex conjugates
% Interweave left/right points
...
subplot(2,1,1)
semilogy(1:max_x, pr_hsvs(1:max_x), 'o', LineWidth=1.5,MarkerSize=10)
hold on
